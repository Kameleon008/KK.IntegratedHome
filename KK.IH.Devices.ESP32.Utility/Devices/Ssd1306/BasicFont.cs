...
namespace KK.IH.Devices.ESP32.Utility.Devices.Ssd1306
{
    ...
    public class BasicFont : IFont
    {
        ...
        /// <summary> Get the binary representation of an ASCII character from the font table. </summary>
        /// <param name="character">Character to look up.</param>
        /// <returns> Byte array containing the rows of pixels in the character.  Unknown byte codes will result in a space being returned.</returns>
